...
| Velora Free Version                                                                             | Velora Premium Version                                                                        |
| ------------------------------------------------------------------------------------------------ | :--------------------------------------------------------------------------------------------- |
| [Demo](https://demos.themeselection.com/velora-vuetify-vuejs-admin-template-free/demo/dashboard)          | [Demo](https://themeselection.com/item/velora-vuetify-vuejs-admin-template/?tab=details#details)           |
| [Download](https://icreatorstudio.com/product/velora-free-vuejs-admin-template)        | [Purchase](https://themeselection.com/item/velora-vuetify-vuejs-admin-template/)           |
...
Check out our live [Documentation](https://demos.themeselection.com/velora-vuetify-vuejs-admin-template/documentation/)
...
If you want to [Download Free Admin Templates](https://themeselection.com/item/category/free-admin-templates/) like Velora then do visit [ThemeSelection](https://themeselection.com/).
